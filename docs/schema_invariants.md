...
- `inventory_adjustment_items.new_quantity >= 0`
- `inventory_adjustment_items.old_quantity` co the am de phan anh dung ton thuc truoc dieu chinh
...
- `InventoryAdjustmentItem.delta_quantity`
  ...
  - `old_quantity` la snapshot audit cua ton truoc dieu chinh nen khong bi clamp ve 0 neu ton dang am
